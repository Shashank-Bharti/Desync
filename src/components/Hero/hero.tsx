  ...
  return (
    ...
    <div className="relative z-999 flex -mt-8 flex-col p-2 items-center gap-3 ">
      ...
      <div className="flex-col flex mb-2 lg:mb-4 items-center justify-center text-[32px] leading-tight lg:text-5xl tracking-tight gap-1">
        <span className="inline-flex  text-green-500 font-light text-xs lg:text-sm mb-2 bg-zinc-800/50 ring ring-zinc-700 px-2 backdrop-blur-md shadow-md shadow-zinc-950  tracking-normal py-1">
        Anonymously</span>
