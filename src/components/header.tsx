...
export function Header() {
    ...
    <span className="flex gap-5">
        ...
        <Image width={20} src={infoIcon} alt="github.com" className="hover:opacity-60 duration-150"/>
        </Link>
        <Link href={"https://github.com/shashank-bharti"} target="_blank" className="hover:opacity-60 duration-150">
